...
<%
    ...
    PostComment comment = new PostComment(postNum, userID, "테스트용닉네임", "images/15fd24a290e3154d44f486b0720b0692_res.jpeg", commentContent, commentRate, format1.format(date));
